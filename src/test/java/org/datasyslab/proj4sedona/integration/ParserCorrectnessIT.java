...
/**
 * Integration tests for CRS parsing correctness.
 * 
 ...
 * </ul>
 */
public class ParserCorrectnessIT {

    private static final String REFERENCE_FILE = "/pyproj-reference/parsing_reference.json";
    ...
    private static JsonObject loadReferenceData() throws IOException {
        try (InputStream is = ParserCorrectnessIT.class.getResourceAsStream(REFERENCE_FILE)) {
            if (is == null) {
