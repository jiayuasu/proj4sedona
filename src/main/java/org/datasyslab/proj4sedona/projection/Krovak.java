...
public class Krovak implements Projection {
    ...
    public void init(ProjectionParams params) {
        ...
        // Persist every effective defining parameter. The serializer needs the resolved
        // defaults, while k0Specified continues to distinguish omission from explicit input.
