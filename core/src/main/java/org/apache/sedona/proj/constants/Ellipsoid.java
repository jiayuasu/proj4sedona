...
/**
 * Ellipsoid definitions for various reference ellipsoids.
 * This class contains the same ellipsoid definitions as the JavaScript version.
 */
public final class Ellipsoid {
    ...
    static {
        ...
        ELLIPSOIDS.put("clrk80ign", new EllipsoidDef(6378249.2, 6356515, 293.4660213, "Clarke 1880 (IGN)"));
