...
/**
 * Lambert Conformal Conic projection implementation. This is a conformal conic projection commonly
 * used for mapping large areas that are predominantly east-west in extent.
 */
public class LambertConformalConic {
  ...
  public static void init(Projection proj) {
    ...
    double ts0 =
        Math.abs(Math.abs(proj.lat0) - Values.HALF_PI) < Values.EPSLN
