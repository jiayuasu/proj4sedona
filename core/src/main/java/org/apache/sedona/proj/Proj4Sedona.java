...
/**
 * Main entry point for the Proj4Sedona library. This class provides the same API as the JavaScript
 * proj4 library.
 */
public class Proj4Sedona {
  ...
  public static Point transform(
      Projection fromProj, Projection toProj, Point coords, boolean enforceAxis) {
    ...
    if ("longlat".equals(fromProj.projName)) {
      ...
      if (fromProj.to_meter != 0) {
        point =
            new Point(point.x * fromProj.to_meter, point.y * fromProj.to_meter, point.z, point.m);
      }
    ...
    if (fromProj.datum != null && toProj.datum != null) {
      point =
          org.apache.sedona.proj.datum.DatumTransform.transform(
              fromProj.datum, toProj.datum, point);
      if (point == null) {
        return null;
      }
    }
   ...
   */
  public static Point transform(
      ProjJsonDefinition fromProjJson, ProjJsonDefinition toProjJson, Point coords) {
  ...
  public static Converter converter(
      ProjJsonDefinition fromProjJson, ProjJsonDefinition toProjJson) {
    Projection from = fromProjJson(fromProjJson);
    Projection to = fromProjJson(toProjJson);
    return new Converter(from, to, false);
  }
   ...
   * @return a BatchTransformer instance
   */
  public static BatchTransformer createBatchTransformer(
      String fromProj, String toProj, boolean enforceAxis) {
   ...
   */
  public static BatchTransformer createBatchTransformer(
      Projection fromProj, Projection toProj, boolean enforceAxis) {
    return new BatchTransformer(fromProj, toProj, enforceAxis);
  }
   ...
   */
  public static java.util.List<Point> transformBatch(
      String fromProj, String toProj, java.util.List<Point> points) {
   ...
   */
  public static Point[] transformArrays(
      String fromProj, String toProj, double[] xCoords, double[] yCoords) {
    BatchTransformer transformer = createBatchTransformer(fromProj, toProj);
  ...
  /**
   * Loads a GeoTIFF datum grid from a URL (e.g., from PROJ CDN). This is equivalent to proj4js
   * nadgrid() function for GeoTIFF files.
   *
   ...
   * @throws IOException if reading fails
   */
  public static GeoTiffReader.GeoTiffGrid nadgrid(String key, java.io.InputStream inputStream)
      throws IOException {
  ...
  /**
   * Downloads and loads a datum grid from the PROJ CDN. This is a convenience method that downloads
   * grids from https://cdn.proj.org/
   *
   ...
   * @throws IOException if downloading or parsing fails
   */
  public static GeoTiffReader.GeoTiffGrid downloadGrid(String key, String gridName)
      throws IOException {
   ...
   * @throws IOException if downloading or parsing fails
   */
  public static GeoTiffReader.GeoTiffGrid downloadGridFromUrl(String key, String url)
      throws IOException {
