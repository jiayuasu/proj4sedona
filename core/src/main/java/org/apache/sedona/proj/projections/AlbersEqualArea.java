...
/**
 * Albers Equal Area Conic projection implementation. This is an equal-area conic projection
 * commonly used for mapping large areas that are predominantly east-west in extent.
 */
public class AlbersEqualArea {
  ...
  /**
   * Function to compute phi1, the latitude for the inverse of the Albers Conical Equal-Area
   * projection.
   */
