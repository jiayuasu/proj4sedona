...
/**
 * Client for downloading datum grids from the PROJ CDN. This provides easy access to the official
 * PROJ datum grids hosted at https://cdn.proj.org/
 */
public class ProjCdnClient {
  ...
  private static final Map<String, GeoTiffReader.GeoTiffGrid> GRID_CACHE =
  ...
  /**
   * Downloads a grid file as an InputStream without parsing it. This can be useful for custom
