...
public class DatumTransformTest {
    ...
    public void setUp() {
        ...
        wgs84Datum.setEllipsoidParams(6378137.0, 6356752.314245, 0.0066943799901413165, 0.006739496742276434);
        ...
        nad27Datum = new Datum.DatumDef(null, "@conus,@alaska,@ntv2_0.gsb,@ntv1_can.dat", 
                                      "clrk66", "NAD27", Values.PJD_GRIDSHIFT);
    ...
    public void testCompareDatums() {
        ...
        // Note: WGS84 and NAD83 are considered identical because they have the same ellipsoid parameters
    ...
    public void testGeocentricToGeodetic() {
        ...
        Point backToGeodetic = DatumTransform.geocentricToGeodetic(geocentric, wgs84Datum.es, wgs84Datum.a, wgs84Datum.b);
    ...
    public void testGeocentricToWgs84_3Param() {
        ...
        testDatum.setEllipsoidParams(6378137.0, 6356752.314245, 0.0066943799901413165, 0.006739496742276434);
        
        Point geocentric = new Point(1000.0, 2000.0, 3000.0);
        Point transformed = DatumTransform.geocentricToWgs84(geocentric, Values.PJD_3PARAM, testDatum.datum_params);
    ...
    public void testGeocentricFromWgs84_3Param() {
        ...
        Point transformed = DatumTransform.geocentricFromWgs84(wgs84, Values.PJD_3PARAM, testDatum.datum_params);
    ...
    public void testTransformWithNoDatum() {
        ...
        noDatum.setEllipsoidParams(6378137.0, 6356752.314245, 0.0066943799901413165, 0.006739496742276434);
