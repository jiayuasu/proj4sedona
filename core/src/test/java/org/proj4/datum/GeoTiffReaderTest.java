...
public class GeoTiffReaderTest {
    ...
    class GridRegistrationTests {
        ...
        void testGridRegistration() {
            ...
            GeoTiffReader.GeoTiffGrid grid = new GeoTiffReader.GeoTiffGrid("test_grid", new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
        ...
        void testMultipleGrids() {
            ...
            GeoTiffReader.GeoTiffGrid grid1 = new GeoTiffReader.GeoTiffGrid("grid1", new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
            GeoTiffReader.GeoTiffGrid grid2 = new GeoTiffReader.GeoTiffGrid("grid2", new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
            GeoTiffReader.GeoTiffGrid grid3 = new GeoTiffReader.GeoTiffGrid("grid3", new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
        ...
        void testClearGrids() {
            GeoTiffReader.GeoTiffSubgrid subgrid = createTestSubgrid();
            GeoTiffReader.GeoTiffGrid grid = new GeoTiffReader.GeoTiffGrid("test", new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
    ...
    class GridInterpolationTests {
        ...
        void testInterpolationOutsideBounds() {
            ...
            double[] outsideShifts = GeoTiffReader.interpolateGrid(grid, Math.toRadians(10.0), Math.toRadians(10.0));
            assertThat(outsideShifts).isNull();
            
            // Test at grid edges (should be null since we're outside)
            double[] edgeShifts = GeoTiffReader.interpolateGrid(grid, Math.toRadians(1.0), Math.toRadians(1.0));
        ...
        void testMultipleSubgrids() {
            ...
            GeoTiffReader.GeoTiffGrid grid = new GeoTiffReader.GeoTiffGrid("multi_grid", 
                new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
            
            // Test interpolation at a point clearly within the grid bounds
            double[] shifts = GeoTiffReader.interpolateGrid(grid, Math.toRadians(0.0), Math.toRadians(0.0));
            assertThat(shifts).isNotNull();
    ...
    class IntegrationTests {
        ...
        void testProj4SedonaIntegration() {
            GeoTiffReader.GeoTiffSubgrid subgrid = createTestSubgrid();
            GeoTiffReader.GeoTiffGrid grid = new GeoTiffReader.GeoTiffGrid("integration_test", 
                new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
    ...
    class PerformanceTests {
        ...
        void testLargeGridPerformance() {
            ...
            GeoTiffReader.GeoTiffSubgrid subgrid = new GeoTiffReader.GeoTiffSubgrid(
                -50.0, 50.0, -50.0, 50.0, 1.0, 1.0, size, size,
                latShifts, lonShifts
            );
            
            GeoTiffReader.GeoTiffGrid grid = new GeoTiffReader.GeoTiffGrid("large_grid", 
                new GeoTiffReader.GeoTiffSubgrid[]{subgrid});
    ...
    class ExampleBasedTests {
        ...
        void testMockGridCreationAndUsage() {
            ...
            GeoTiffReader.GeoTiffSubgrid subgrid = new GeoTiffReader.GeoTiffSubgrid(
                -85.0, -75.0, 40.0, 50.0,  // Bounds covering part of Canada
                0.1, 0.1,  // 0.1 degree spacing
                100, 100,  // 100x100 grid
                createMockLatShifts(100, 100),  // Mock latitude shifts
                createMockLonShifts(100, 100)   // Mock longitude shifts
            );
            
            GeoTiffReader.GeoTiffGrid mockGrid = new GeoTiffReader.GeoTiffGrid(
        ...
        void testMultipleGridsExample() {
            ...
            String[] gridNames = {
                "ca_nrc_NA83SCRS.tif",
                "us_noaa_NAD83_NAD83_CSRS.tif"
            };
            
            for (String gridName : gridNames) {
                // Create a simple mock grid
                GeoTiffReader.GeoTiffSubgrid subgrid = new GeoTiffReader.GeoTiffSubgrid(
                    -180.0, 180.0, -90.0, 90.0, 1.0, 1.0, 10, 10,
