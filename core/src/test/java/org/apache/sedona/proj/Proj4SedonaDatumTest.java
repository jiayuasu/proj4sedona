...
public class Proj4SedonaDatumTest {
  ...
  public void testTransformWithDifferentDatums() {
    ...
    Point result =
        Proj4Sedona.transform("+proj=longlat +datum=WGS84", "+proj=longlat +datum=NAD83", point);
  ...
  public void testConverterWithDatumTransformation() {
    ...
    Proj4Sedona.Converter converter =
        Proj4Sedona.converter("+proj=longlat +datum=WGS84", "+proj=longlat +datum=NAD83");
