...
public class GridShiftTest {
  ...
  public void testRegisterAndGetGrid() {
    ...
    GridShift.GridFile testGrid =
        new GridShift.GridFile(
            "test_grid",
            -90.0,
            90.0,
            -180.0,
  ...
  public void testRemoveGrid() {
    ...
    GridShift.GridFile testGrid =
        new GridShift.GridFile(
            "test_grid", -90.0, 90.0, -180.0, 180.0, 1.0, 1.0, 1, 1, latShifts, lonShifts);
  ...
  public void testInterpolateGrid() {
    ...
    GridShift.GridFile testGrid =
        new GridShift.GridFile(
            "test_grid", -90.0, 90.0, -180.0, 180.0, 1.0, 1.0, 2, 2, latShifts, lonShifts);
