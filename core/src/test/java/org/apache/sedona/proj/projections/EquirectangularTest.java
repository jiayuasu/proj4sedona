...
/** Test cases for Equirectangular projection (Plate Carrée). */
public class EquirectangularTest {

  private static final double TOLERANCE = 1.0;
  private static final double COORD_TOLERANCE = 1e-8;

  @Test
  public void testEquirectangularInitialization() {
    String projString = "+proj=eqc +lon_0=0 +lat_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m";
    Projection proj = new Projection(projString);

    assertNotNull(proj);
    assertTrue(proj.projName.equals("eqc") || proj.projName.equals("equi"));
  }

  @Test
  public void testEquirectangularCenter() {
    String projString = "+proj=eqc +lon_0=0 +lat_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m";
    Projection proj = new Projection(projString);
  ...
  @Test
  public void testEquirectangularWithStandardParallel() {
    // Equirectangular with standard parallel at 30°N
    String projString = "+proj=eqc +lat_ts=30 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m";
    Projection proj = new Projection(projString);
  ...
  @Test
  public void testEquirectangularMultiplePoints() {
    String projString = "+proj=eqc +lon_0=0 +lat_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m";
    Projection proj = new Projection(projString);
