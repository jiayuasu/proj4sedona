...
public class ProjCdnClientTest {
  ...
  class GridDownloadTests {
    ...
    void testNetworkErrors() {
      ...
      assertThatThrownBy(
              () ->
                  ProjCdnClient.downloadGridFromUrl(
                      "test", "http://unreachable.example.com/grid.tif"))
          .isInstanceOf(IOException.class);
    }
  ...
  class IntegrationTests {
    ...
    void testProj4SedonaDownloadIntegration() {
      // Test download operations (these will fail with network errors, but should be handled
      // gracefully)
  ...
  class ExampleBasedIntegrationTests {
    ...
    void testLocalFileLoadingExample() throws NoSuchMethodException {
      ...
      assertThat(Proj4Sedona.class.getMethod("nadgrid", String.class, InputStream.class))
          .isNotNull();
      assertThat(
              Proj4Sedona.class.getMethod(
                  "registerNadgrid", String.class, GeoTiffReader.GeoTiffGrid.class))
          .isNotNull();
    }
    ...
    void testCdnDownloadExample() throws NoSuchMethodException {
      ...
      // The example shows: GeoTiffReader.GeoTiffGrid grid =
      // Proj4Sedona.downloadGrid("ca_nrc_NA83SCRS.tif");
      ...
      assertThat(Proj4Sedona.class.getMethod("downloadGridFromUrl", String.class, String.class))
          .isNotNull();
    }
    ...
    void testGridTransformationExample() throws NoSuchMethodException {
      ...
      assertThat(Proj4Sedona.class.getMethod("transform", String.class, String.class, Point.class))
          .isNotNull();
    }
