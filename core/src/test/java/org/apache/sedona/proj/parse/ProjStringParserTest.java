...
public class ProjStringParserTest {
  ...
  public void testGetProjectionName() {
    assertThat(ProjStringParser.getProjectionName("+proj=merc +datum=WGS84 +no_defs"))
        .isEqualTo("merc");
    assertThat(ProjStringParser.getProjectionName("+proj=longlat +datum=WGS84 +no_defs"))
        .isEqualTo("longlat");
  ...
  public void testGetEllipsoid() {
    assertThat(ProjStringParser.getEllipsoid("+proj=merc +ellps=WGS84 +no_defs"))
        .isEqualTo("WGS84");
    assertThat(ProjStringParser.getEllipsoid("+proj=merc +ellps=GRS80 +no_defs"))
        .isEqualTo("GRS80");
