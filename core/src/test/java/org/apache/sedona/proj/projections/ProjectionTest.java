...
public class ProjectionTest {
  ...
  public void testTransverseMercator() {
    // Test TM projection
    String projString =
        "+proj=tmerc +lat_0=0 +lon_0=-96 +k=1 +x_0=500000 +y_0=0 +datum=WGS84 +units=m +no_defs";
    Projection proj = new Projection(projString);
  ...
  public void testProj4SedonaIntegration() {
    ...
    Point result =
        Proj4Sedona.transform(
            "+proj=lcc +lat_1=33 +lat_2=45 +lat_0=39 +lon_0=-96 +datum=WGS84", input);
    assertNotNull(result);
    ...
    Point aeaResult =
        Proj4Sedona.transform(
            "+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23 +lon_0=-96 +datum=WGS84", input);
